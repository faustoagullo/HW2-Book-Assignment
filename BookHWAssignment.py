...
save_locally()
unique_words = len(get_unique_words())
unique_words_2 = len(get_unique_words_2())

print(f"Pride and Prejudice has:{unique_words} unique words.")
print(f"Alice in Wonderland has: {unique_words_2} unique words.")
